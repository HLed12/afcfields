...
multi_site_list <- lapply(1:500, function(x) {
...
par(mfrow = c(1, 2))
boxplot(unlist(all_fld_means), outline = TRUE, border = "blue", main = "Field Agreement Means", ylim = c(0, 1))
boxplot(unlist(all_nofld_means), outline = TRUE, border = "red", main = "No Field Agreement Means", ylim = c(0, 1))
```
From this subset, it seems that agreement for a field was more difficult throughout sites than agreement for not a field. We will test below if extreme outliers are the cause of this.
...
par(mfrow = c(1, 2))
boxplot(all_fld_out, outline = TRUE, names = "No Field Agreement Mean", border = "blue", main = "Field Agreement Means", ylim = c(0, 1))
boxplot(all_nofld_out, outline = TRUE, names = "Field Agreement Mean", border = "red", main = "No Field Agreement Means", ylim = c(0, 1))
...
all_nofld_out_mean
```
This shows that the extreme scenarios make an impact, but not a large one. Agreement
for a field is still more difficult for these sites.