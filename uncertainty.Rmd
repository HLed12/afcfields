...
```{r}
set.seed(9)
#plot(conf_class_list[[9]], mar = c(0, 1, 0, 12)) # fix colors or disgard
...
# explain that 72.6% are agreement of field or no-field. 
```
...
Need to rename variables, remove "test" from all.